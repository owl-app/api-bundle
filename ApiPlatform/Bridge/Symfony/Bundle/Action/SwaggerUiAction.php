...
namespace Owl\Bundle\ApiBundle\ApiPlatform\Bridge\Symfony\Bundle\Action;
...
final class SwaggerUiAction
{
    ...
    public function __invoke(Request $request)
    {
        ...
        return new Response($this->twig->render('@OwlApi/SwaggerUi/index.html.twig', $this->getContext($request, $documentation) + ['formats' => $formats]));
    }
